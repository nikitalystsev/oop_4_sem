...
int main() {
    ...
    if (my_matrix != my_matrix3) std::cout << "матрицы не равны" << "\n\n";
    else std::cout << "матрицы равны" << "\n\n";
    ...
    new_matrix.fill(new_matrix.end() - static_cast<int>(new_matrix.get_columns()), new_matrix.end(), "0");
    std::cout << new_matrix << "\n\n";
